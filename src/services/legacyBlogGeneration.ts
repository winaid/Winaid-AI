/**
 * legacyBlogGeneration.ts — 레거시 단일 블로그 생성 함수
 *
 * @deprecated 주 경로는 blogPipelineService.ts의 generateBlogWithPipeline.
...
import { GEMINI_MODEL, TIMEOUTS, callGemini, getAiProviderSettings } from "./geminiClient";
import { GenerationRequest, FactCheckReport, SeoScoreReport, WritingStyle } from "../types";
import { getStage1_ContentGeneration, getDynamicSystemPrompt } from "../lib/gpt52-prompts-staged";
import {
  FEW_SHOT_EXAMPLES,
  CATEGORY_SPECIFIC_PROMPTS,
} from "../utils/humanWritingPrompts";
import { getTopCompetitorAnalysis } from "./naverSearchService";
...
import { evaluateSeoScore } from "./seoService";
import {
  SEARCH_TIMEOUT_MS,
  DEFAULT_IMAGE_STYLE,
