...
🔥🔥🔥 [문체 규칙] - AI 말투 탈피! 🔥🔥🔥
- "~합니다", "~됩니다" 기본 어미 사용
- 🚨 "~있습니다/~수 있습니다" 비율 30% 이하로 제한! (50% 넘으면 AI 냄새!)
- 아래 어미를 골고루 섞어야 자연스러움:
  • "~는 경우가 있습니다" (관찰)
  • "~기도 합니다" (부가 정보, 글 전체 3회 이하)
  • "~는 편입니다" (경향)
  • "~다고 합니다" (전해 듣기)
  • "~때가 있습니다" (시점)
  • "~과 관련이 있을 수 있습니다" (원인)
- 연속 3문장 같은 어미 금지! 반드시 섞기!
- ❌ "~있습니다. ~있습니다. ~있습니다." (단조로움)
- ✅ "~있습니다. ~는 편입니다. ~기도 합니다." (자연스러움)
🔥 권유는 **마지막 소제목의 마지막 문단에서만 딱 한 번** 허용!
...
🚨 [핵심] 3인칭 관찰자 시점 글쓰기 - AI 냄새 제거!
① 도입부 마무리: "오늘은 ~에 대해 알아보겠습니다" 절대 금지! → 방향 제시 문장으로!
② 어미 다양화: 같은 어미 연속 3회 금지. "~는 경우가 있습니다", "~는 편입니다" 등으로 분산!
③ 🚫 독자 말 걸기 절대 금지: "~한 적 있으신가요?", "~해보세요", "~하더라고요" 등 사용 불가!
④ 구체적 상황 묘사: 추상적 설명 금지 → 3인칭 관찰 시점의 구체적 일상 장면으로!
⑤ 정보 나열에 숨 고르기: 기능/현상 설명식 문장 금지 → 체감 중심 표현으로!
...
🚨🚨🚨 문단 개수 절대 규칙 (위반 = 실패!) 🚨🚨🚨
[본문 소제목] 각 소제목당 최대 3문단! (4문단 이상 = 실패!)
[마지막 소제목] 반드시 2문단 이하! (3문단 이상 = 무조건 실패!)
⚠️ <p> 태그 1개 = 1문단 (이것으로 확인!)

[구조 규칙]
- **소제목 개수**: 최소 4개 이상 (3개 이하 = 실패! 절대 규칙 B 참조)
- **일반 소제목**: 문단 최대 3개 (4개 이상 ❌)
- **마지막 소제목**: 문단 최대 2개 (3개 이상 ❌❌❌)

[작성 후 필수 검증 단계]
1. 각 소제목 아래의 <p> 태그 개수를 센다
2. 본문 소제목: 4개 이상이면 → 3개 이하로 병합
3. 마지막 소제목: 3개 이상이면 → 반드시 2개로 병합
4. 검증 통과한 결과만 출력!
❗ 본문 소제목 4문단 = 실패 / 마지막 소제목 3문단 = 실패
