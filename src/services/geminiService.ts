...
`;
  ...
  // 🎭 톤(말투) 프롬프트 - warm/logical/premium
...
- 감정을 인정하는 표현 활용: "걱정되실 수 있습니다", "불안하셨을 겁니다"
`,
    logical: `
[말투: 논리적이고 명확한 톤 🧠]
- 근거 중심의 정확한 정보 전달
- 원인→결과 순서로 논리적 흐름 유지
- 감정적 표현 최소화, 팩트 위주
- "~때문입니다", "~원리는 이렇습니다", "~구조적으로 보면"
- 의학 용어를 쉽게 풀어서 설명하되 정확성 유지
`,
    premium: `
[말투: 고급스럽고 신뢰감 있는 톤 ✨]
- 격조 있고 세련된 문체
- 급하지 않고 차분하며 여유 있는 어조
- "~살펴보겠습니다", "~이해하시면 도움이 됩니다"
- 불필요한 이모지나 구어체 최소화
...
`
  ...
  // 🎭 페르소나 프롬프트 - hospital_info/director_1st/coordinator
...
💬 [상담 실장님 시점 모드]
────────────────────
⚠️ 이 글은 병원 상담 실장이 쓴 것처럼 친근한 시점으로 작성합니다.
- 환자와 가장 가까이서 소통하는 상담사 시점
- "저희 병원에 오시는 분들 중에~", "상담하다 보면~"
- 친근하고 편안한 어조, 실제 경험담 느낌
- 후기형/안내형 글에 적합
- 의학적으로 깊은 설명보다는 과정/경험 중심 서술
`
  };
