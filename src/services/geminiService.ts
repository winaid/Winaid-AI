...
[핵심 - 하나의 장면, 하나의 흐름]
도입부는 하나의 사건이 시간 순서대로 전개되는 이야기여야 합니다.
여러 상황을 나열하지 마세요 ("경우가 있습니다" + "하기도 합니다" 반복 = 실패).
