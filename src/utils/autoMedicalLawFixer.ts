...
const EXAGGERATION_REPLACEMENTS: Record<string, string> = {
  ...
  // 정확도 과장 (의료광고 심의 민감)
  '명확하게 찾아': '여부를 확인할 수 있도록',
  '명확히 찾아': '여부를 확인할 수 있도록',
  '정확하게 찾아': '여부를 확인하는 데 도움이 되도록',
  '정확하게 확인': '여부를 파악',
  '확실하게 구분': '구분하는 데 도움이 될 수',
  '완벽하게 차단': '예방하는 데 도움이 될 수',
  '완벽하게 막': '줄이는 데 도움이 될 수',
  '밝혀낼 수': '파악하는 데 도움이 될 수',
  '규명할 수': '파악하는 데 도움이 될 수',
  '판별해낼 수': '구분하는 데 참고할 수',
...
export function fixExaggeration(text: string): {
  ...
  // 🆕 "것이 좋습니다" 맥락 의존 필터링
  // 병원 유도형 동사에서만 완화, 일반 건강 습관("검진을 꾸준히 해주는 것이 좋습니다")은 허용
  // ❌ 필터: 병원 방문/의료 서비스 유도 동사
  // ✅ 허용: 검진, 검사, 관리, 섭취, 복용, 운동, 수면, 금연, 금주, 접종 등 일반 건강 습관
  const medicalVerbs = '치료|상담|진료|방문|진찰|처방|투약';
