...
[1] 공감의 시작 (도입부) - 🔥 "아침" 반복 금지! 다양하게!
⚠️ "아침에 일어났을 때~"는 너무 흔함! 다른 시점/상황으로 시작하세요!

✅ 다양한 도입 예시 (희소성 확보):
  • 시간: "퇴근길 지하철에서 문득", "샤워하다가 거울을 보니", "자려고 누웠는데"
  • 행동: "계단을 오르다 보면", "오래 앉아 있다 일어설 때", "무거운 걸 들다가"
  • 상황: "유독 그 자세만 취하면", "요즘 들어 부쩍", "어느 순간부터인가"
  • 계기: "옷을 입다가 불편해서", "평소 안 그랬는데", "전에는 몰랐던"
...
[3] 감각 표현 (AI 냄새 제거) - 🔥 묘사 80% 수준으로! 과하면 AI 냄새!
⚠️ 감각 묘사를 매 문장에 넣지 마세요! 핵심 포인트에만!

✅ 적절한 수준 (10문장 중 2~3문장만 묘사):
  • "뻐근한 느낌이 들기도 합니다" (한 번 언급)
  • 나머지는 담백하게: "비슷한 느낌이 반복됩니다", "달라진 부분이 있습니다"
...
✅ 다양한 시점 활용 (아침만 반복 금지!):
   • "저녁이면 ○○해지는 경우", "오래 앉아 있다 보면", "무언가를 하다가 문득"
...
🔴🔴🔴 단정형 표현 완전 금지 (v6.6 최우선!):
  ⚠️ 모든 문장은 반드시 완화 표현으로 끝나야 함!
  
  ❌ 단정형 (발견 즉시 수정!):
    • ~입니다 → ✅ "~일 수 있습니다", "~인 경우가 있습니다"
    • ~합니다 → ✅ "~하는 경우가 있습니다", "~하기도 합니다"
    • ~됩니다 → ✅ "~될 수 있습니다", "~되기도 합니다"
    • ~나타납니다 → ✅ "~나타날 수 있습니다", "~나타나기도 합니다"
    • ~있습니다 (단정) → ✅ "~있을 수 있습니다"
    • 원인입니다 → ✅ "원인이 될 수 있습니다"
    • 유발합니다 → ✅ "관련이 있을 수 있습니다"
    • ~로 이어집니다 → ✅ "이어질 수 있습니다"
  ...
  🔥 점검: 문장 끝에 "수 있습니다/경우가 있습니다/기도 합니다/편입니다" 없으면 단정형!
...
❌ "기대할 수 있습니다" - 절대 금지 (0회)
❌ "기대됩니다" - 절대 금지 (0회)
❌ "기대해 볼 수 있습니다" - 절대 금지 (0회)
❌ "호전을 기대" - 절대 금지 (0회)
❌ "개선을 기대" - 절대 금지 (0회)
❌ "효과를 기대" - 절대 금지 (0회)
  • "기대할 수 있습니다" ❌ → "가능합니다" ✅ 또는 삭제
  • "호전을 기대" ❌ → "나아질 수 있습니다" ✅
  • "개선이 기대됩니다" ❌ → "나아질 수 있습니다" ✅
...
✅ 수동적·중립적 안내만 가능 (횟수 제한 엄수!):
  ...
  ⚠️ "확인이 도움될 수 있습니다" - 전체 글에서 최대 1회만! (반복 시 병원 유도로 오인)
  ⚠️ "살펴보는 것도 방법" - 전체 글에서 최대 1회만!
  
  Level 1 (가장 안전 - 중립적 종결):
    "개인차가 있을 수 있습니다"
    "상황에 따라 다를 수 있습니다"
    "비슷한 경험을 하는 경우가 있습니다"
  
  Level 2 (허용 - 단, 1회만):
    "변화를 살펴보는 것도 한 가지입니다" (마무리에서 1회만)
  
  ❌ 더 이상 사용하지 마세요:
    "확인을 받아보는 것도 방법" - 직접적 행동 유도로 오인!
    "진료를 받아보는 것도" - 의료광고!
    "병원을 찾아보는 것도" - 의료광고!
...
⚠️ 핵심 원칙:
  ...
  • "~해야", "~필요" 같은 의무 표현 금지
  • "~도움이 된다" 단정 금지
  • 🚨 "~도움될 수 있습니다"도 전체 글에서 1회만! (반복 시 병원 유도로 오인)
  • 마무리는 "개인차가 있을 수 있습니다" 정도로 중립적 종결

위반 예시:
  ❌ "규칙적인 운동이 필요합니다"
  ❌ "스트레칭을 해보세요"
  ❌ "충분한 수분 섭취가 도움이 됩니다" (단정)
  ❌ "확인이 도움될 수 있습니다" (반복 사용 시 - 병원 유도!)
  ❌ "병원을 찾아보는 것도 좋은 방법입니다" (직접 유도 + 가치 판단!)
  ✅ "개인차가 있을 수 있습니다" (중립적 종결)
  ✅ "상황에 따라 다를 수 있습니다" (중립적 종결)
...
🎯 [ 분량 목표: ${textLength}자 ] ⚠️ 반드시 채우기!
📐 소제목 3~4개 | 글자수 ${textLength}자 채우기 (문단/문장 개수는 자유)

🚨🚨🚨 글자수 목표 반드시 달성! (부족하면 탈락!)
   • 최소: ${Math.round(textLength * 0.9)}자 이상 (이 미만 = 불합격!)
   • 목표: ${textLength}자 (정확히 맞추기!)
   • 최대: ${Math.round(textLength * 1.1)}자 이하
   
🔴🔴🔴 글자수 부족 시 해결법:
   • 각 소제목 아래 문단 2~3개씩 작성
   • 구체적인 상황/예시 추가 ("아침에", "저녁에", "계단을 오를 때")
   • 감각 표현 추가 ("뻐근한", "묵직한", "찌릿한")
   • 독자 공감 문장 추가 ("이런 경험이 있는 분들이 많습니다")
   • **절대 짧게 끝내지 마세요! 목표 분량 채우기!**
...
✅ 4. 글자수 ${textLength}자 반드시 채우기! (부족하면 안 됨)
...
[P2] ⚠️ 반드시 준수 - 분량 규칙:
  ...
  🚨🚨🚨 **글자수 반드시 채우기!**:
  ┌─────────────────────────────────────────┐
  │ ⚠️ 허용 범위: ${Math.round(textLength * 0.9)}자 ~ ${Math.round(textLength * 1.05)}자   │
  │ ❌ ${Math.round(textLength * 0.9)}자 미달 = 내용 부족!             │
  └─────────────────────────────────────────┘
...
4️⃣ 마지막 소제목 작성 (🚨🚨🚨 CRITICAL - 최우선 규칙!):
  ...
  ✅ 마무리 톤 (심의 기준 - v6.5 강화!):
    ...
    ✅ 권장 (자연스러운 종결 - 앞 문장과 연결되게!):
      • "이런 경험을 하는 경우가 많습니다."
      • "자신의 상황에 맞게 살펴보는 것도 방법입니다."
      • "비슷한 고민을 하는 경우가 있습니다."
    
    🚫 절대 금지 (기계적 문장 연결):
      • "~할 수 있습니다. 개인차가 있을 수 있습니다." ← 이런 식으로 2문장 기계적 연결 금지!
      • 앞 문장과 연결 없이 뜬금없이 "개인차가 있을 수 있습니다" 붙이기 금지!
...
🚨 1. 불안 자극 표현 절대 금지:
  ...
  ✅ "이런 경험을 하는 경우가 있습니다" / "상황에 따라 다릅니다"

🚨 2. 단정적 인과관계 + 의학적 해석 절대 금지:
  ❌ 유발한다/초래한다/이어진다/~때문에/관련이 있다(단정형)
  ❌ 진행성/조직 자극/세포 변화/~의 신호/~의 징후 (자기진단 유도)
  ✅ "느낌이 나타나기도 합니다" / "관련될 수 있습니다"

🚨 3. 행동 유도 + 가치 판단 절대 금지:
  ❌ ~하세요/필요합니다/해야/~이 좋습니다
  ❌ "병원을 찾아", "진료를 받아" (직접 행동 유도)
  ❌ "좋은 방법", "현명한 선택" (가치 판단)
  ✅ 자연스러운 마무리: "자신의 상황에 맞게 살펴보는 것도 방법입니다"

🚨 4. 🔴 기계적 문장 연결 절대 금지 (NEW!):
  ❌ "~할 수 있습니다. 개인차가 있을 수 있습니다." (의미 없는 2문장 연결)
  ❌ "현명할 수 있습니다" (일상어를 억지로 "~수 있습니다"로 바꾸기)
  ✅ 한 문장으로 자연스럽게 마무리: "자신에게 맞는 방법을 찾아보는 것도 좋습니다"
...
15. □ 🚨🚨🚨 v6.5 의료광고 오인 방지 체크 (NEW! - 최우선!):
    
    □ 병원 방문 유도 표현 검색:
       □ "병원을 찾아", "병원에 가" 검색 → 0개 (발견 시 삭제)
       □ "진료를 받아", "검사를 받아" 검색 → 0개 (발견 시 삭제)
    
    □ 가치 판단 표현 검색:
       □ "좋은 방법" 검색 → 0개 (발견 시 "한 가지입니다"로 변경 또는 삭제)
       □ "현명한 선택", "바람직한" 검색 → 0개 (발견 시 삭제)
    
    □ 의학적 해석 용어 검색 (자기진단 유도 방지):
       □ "진행성", "악성", "양성" 검색 → 0개 (의학적 판단 용어)
       □ "조직 자극", "조직 손상", "세포 변화" 검색 → 0개 (기전 설명)
       □ "~의 신호", "~의 징후" 검색 → 0개 (진단 암시)
       → 발견 시 "~느낌이 나타나기도 합니다"로 변경
    
    □ "확인이 도움될 수 있습니다" 반복 체크:
       → 전체 글에서 최대 1회만 허용!
       → 2회 이상 발견 시 "개인차가 있을 수 있습니다"로 변경
    
    □ 마무리 표현 체크:
       → "개인차가 있을 수 있습니다" (중립적 - OK)
       → "상황에 따라 다를 수 있습니다" (중립적 - OK)
       → "변화를 살펴보는 것도 한 가지입니다" (마무리에서 1회만 - OK)
       ❌ "확인을 받아보는 것도 방법" (행동 유도 - 삭제!)
       ❌ "좋은 방법입니다" (가치 판단 - 삭제!)
...
🔧 행동 유도 제거 (v6.5 강화!):
  ❌ "지금 바로 검사를 받으세요"
  ❌ "병원을 방문하는 것이 좋다"
  ❌ "병원을 찾아보는 것도 좋은 방법" (직접 행동 유도 + 가치 판단 - NEW!)
  ❌ "확인이 도움될 수 있다" (반복 사용 시 - 병원 유도로 오인! NEW!)
  ✅ "개인차가 있을 수 있습니다" (중립적 종결)
  ✅ "상황에 따라 다를 수 있습니다" (중립적 종결)

🔧 가치 판단 표현 제거 (v6.5 NEW!):
  ❌ "좋은 방법입니다" → "한 가지입니다" 또는 삭제
  ❌ "현명한 선택" → 삭제
  ❌ "바람직한" → 삭제
  ❌ "올바른 방향" → 삭제

🔧 의학적 해석 용어 제거 (v6.5 NEW! 자기진단 유도 방지):
  ❌ "진행성 질환", "악성", "양성" → 삭제
  ❌ "조직 자극", "조직 손상", "세포 변화" → 삭제
  ❌ "~의 신호", "~의 징후" → 삭제
  ✅ "이런 느낌이 나타나기도 합니다" (느낌 중심)
