...
export const STAGE_C_PRO_TIMEOUT_MS = 40_000;       // PRO 교정 타임아웃 (40s — 이전 25s에서 100% timeout 발생)
...
// 카드뉴스 슬라이드 수 정책은 cardNewsConfig.ts가 SOT.
// 기존 import 호환을 위해 re-export.
import {
  DEFAULT_SLIDE_COUNT as _DEFAULT_SLIDE_COUNT,
  MAX_SLIDE_COUNT as _MAX_SLIDE_COUNT,
} from './cardNewsConfig';

export const DEFAULT_CARD_NEWS_SLIDE_COUNT = _DEFAULT_SLIDE_COUNT;
export const MAX_CARD_NEWS_SLIDE_COUNT = _MAX_SLIDE_COUNT;
