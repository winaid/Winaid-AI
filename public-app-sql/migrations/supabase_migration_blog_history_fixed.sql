-- =====================================================
-- Blog History Table for Similarity Checking (수정판)
-- =====================================================
...
CREATE TABLE public.blog_history (
...
-- 2. 인덱스 생성
-- 사용자별 검색을 위한 인덱스
CREATE INDEX idx_blog_history_user_id 
  ON public.blog_history(user_id);

-- 최신 글 조회를 위한 인덱스
CREATE INDEX idx_blog_history_published_at 
...
-- 선택사항: pgvector 확장 설치
-- =====================================================
-- Supabase에서 pgvector 확장이 설치되어 있지 않다면 다음도 실행:
