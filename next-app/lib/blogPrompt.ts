...
- variable 블록의 [도입 인사] 섹션 헤더가 "(1인칭 허용)" 으로 끝나고 병원명·직책이 명시됐으면,
  HTML 본문의 **절대 첫 문장**은 반드시
    "안녕하세요. {수식구} {병원명} {직책}입니다."
  형식이어야 한다. 공감 훅·질문형·키워드 배치 등 다른 어떤 지시보다 이 규칙이 우선한다.
- 인사 문장은 <p> 태그 안에 단독 문장으로. 그 다음 <p> 부터 공감 훅/질문형/본론 전개.
- [도입 인사] 헤더가 "(1인칭 금지, 3인칭만)" 또는 "(1인칭 인사/병원명 언급 금지)" 이면
  절대 인사 문장을 쓰지 않는다 (위 규칙도 적용 X).
- 말투 학습 블록이 주입됐다면 "안녕하세요" 어미/호흡/쉼표 위치까지 말투 블록 어조를 따라간다.
...
[인사 문장 보존 — 중요]
- 초안 첫 <p> 가 "안녕하세요. ... {병원명} ... (대표 원장|원장|상담실장|코디네이터)입니다." 형태이면
  이는 사용자 설정에 따른 정당한 도입 인사. revisedHtml 작성 시
  **이 첫 <p> 를 삭제하거나 위치를 옮기거나 형식을 바꾸지 마라**.
- 인사 문장 안에 과장·단정 표현이 있으면 **같은 형식 유지한 채 순화만** 한다.
  예) "최고의 치과 대표 원장입니다" → "환자분과 오래 함께해 온 ○○치과 대표 원장입니다."
- 인사를 통째 삭제한 revisedHtml 은 "구조 파괴" 로 간주해 issues 에 category="structure", severity="high" 로 기록하고 복원.`;
