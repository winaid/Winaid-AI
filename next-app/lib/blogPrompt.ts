...
<good>
<p>잇몸이 붓고 양치할 때 피가 나기 시작하면 이미 염증이 시작된 신호예요. 처음에는 가벼운 불편함 정도지만 방치하면 잇몸이 조금씩 내려가면서 찬물에도 시큰한 느낌이 함께 올 수 있습니다.</p>
</good>
<bad reason="증상을 ul/li 로 나열 — 환자 가독성 낮고 SEO 단락 콘텐츠 점수 저하">
<p>잇몸 염증의 주요 증상:</p>
<ul>
<li>잇몸 붓기</li>
<li>양치 시 출혈</li>
...
<good>
<p>충남 지역에서 임플란트를 고민 중이시라면, 수술 자체만큼 이후 관리 계획도 중요합니다. 첫 3개월은 뼈가 안정되는 시기라 자극을 줄여주시는 게 좋고, 이 기간 정기 검진이 특히 중요해요.</p>
</good>
<bad reason="같은 키워드(충남임플란트) 3회 연속 + 짧은 문장 쪼개기 = SEO 스터핑 패턴, 검색엔진 페널티">
<p>충남임플란트는 인공 치아입니다. 충남임플란트는 수술이 필요합니다. 충남임플란트는 관리가 중요합니다.</p>
</bad>
<good>
