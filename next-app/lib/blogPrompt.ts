...
${countingRules}
  ...
  <distribution_formula>
    ...
    3. body 섹션 charTarget = Math.floor((totalTarget-400)/body_count), 마지막 섹션에 나머지 배분
    예: total=1500 → intro 200 + outro 200 + body 3개 × 367 ≈ 1500
        total=2500 → intro 200 + outro 200 + body 6개 × 350 ≈ 2500
  </distribution_formula>
  <self_check>
