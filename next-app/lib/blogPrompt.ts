...
const CATEGORY_DEPTH_GUIDES: Record<string, string> = {
  '치과': `[치과 전문 콘텐츠 가이드]
- 치료 과정을 단계별로 서술: 진단(파노라마/CT) → 치료계획 → 시술 → 경과 관찰
- 장비명 + 환자 체감 이점: "CT 촬영으로 잇몸뼈 상태를 3D로 확인 → 임플란트 위치와 각도를 미리 계획"
- 보철 과정: 인상채득 → 기공소 제작(지르코니아/PFM/올세라믹 차이) → 장착 → 교합 조정
- 환자 불안 해소: 마취 과정, 시술 중 느낌, 회복 기간을 솔직하게
- 비용: 직접 가격 대신 "건강보험 적용 여부", "재료에 따른 차이" 수준으로`,
  '피부과': `[피부과 전문 콘텐츠 가이드]
- 시술 원리를 과학적으로: "프락셀 레이저는 미세한 열 손상으로 콜라겐 재생을 유도"
- 시술 전후 주의사항 구체적으로: 세안 시기, 자외선 차단, 화장 가능 시점
- 피부 타입별 차이: 지성/건성/복합성/민감성에 따른 관리법
- 계절/환경 요인: 자외선, 미세먼지, 건조한 공기
- 홈케어 vs 전문 시술의 차이를 균형있게`,
  '정형외과': `[정형외과 전문 콘텐츠 가이드]
- 해부학적 구조: 관절/인대/연골/근육의 역할과 손상 메커니즘
- 진단 과정: 이학적 검사(맥머리 검사 등) → 영상(X-ray/MRI) → 진단
- 비수술 → 수술 순서: 물리치료, 주사치료, 체외충격파 → 관절경/인공관절
- 재활 구체적으로: 시기별 운동, 일상 복귀 시점, 주의사항
...
각 문단은 최소 3문장, 문장당 평균 30~40자. 2문장짜리 짧은 문단은 만들지 마세요.`;
  ...
  const systemInstruction = [
    ...
    '',
    // ── 긍정 가이드 (이렇게 써라) ──
    '[좋은 문단의 기준 — 모든 문단이 충족해야 함]',
    '- 첫 문장이 문단의 핵심을 담는다 (두괄식)',
    '- 구체적 사실/수치/과정이 최소 1개 있다 (추상적 설명 금지)',
    '- 환자 입장에서의 체감/변화가 1문장 이상 있다',
    '- 마지막 문장은 다음 내용으로의 자연스러운 브릿지 (앞 내용 요약 금지, 다음 주제를 예고)',
    '',
    '나쁜 문단: "임플란트는 치아를 대체하는 좋은 방법입니다. 많은 환자분들이 만족하고 계십니다."',
    '좋은 문단: "임플란트는 빠진 치아 자리의 잇몸뼈에 티타늄 나사를 심고, 그 위에 인공 치아를 얹는 시술입니다. 시술 자체는 30분~1시간 정도 걸리지만, 잇몸뼈와 결합하는 데 약 3~6개월이 필요합니다."',
    '',
    '[문장 리듬과 어미]',
