...
6. ⚠️ 의료광고법 constraints 는 학습 말투보다 절대 상위.
   - representativeParagraphs / goodExamples / openingStyle 안에 "100% 효과", "최고",
     "유일한", "완치", "부작용 없는", "무통" 같은 표현이 있더라도 따라 쓰지 마세요.
   - 의료광고법 금지어는 무조건 medical_law_constraints 블록의 대체어로 변환.
