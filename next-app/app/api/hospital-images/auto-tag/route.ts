...
- **임플란트**: 실제 임플란트 나사(티타늄 픽스처)·지대주(어버트먼트)·임플란트 보철물·식립 수술 장면
  ❌ 일반 치아 모형·사랑니 모형·잇몸/뼈 해부도·턱관절 사진·크라운/인레이 샘플 → "임플란트" 아님
...
6. **뉴스 기사/캡처 감지** — 이미지에 기사 제목·기자명·날짜·신문사 로고·"출처:" 텍스트가 보이면 무조건 "일반" 태그. 시술 태그 절대 금지.
   예: 치과 관련 뉴스 기사 캡처 → "일반" (사랑니 기사라도 "사랑니" 태그 X)
