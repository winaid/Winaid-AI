...
- **부작용**: 시술/치료 후 부작용·합병증·실패 사례·주의 경고 관련 이미지·기사
- **레이저치료**: 치과용 레이저 시술 (치은 성형·민감성 치료·연조직 레이저)
- **치아본**: 디지털 구강 스캐너·본뜨기(인상 채득)·석고 모형 제작 장면
- **교합치료**: 교합 조정·교합 안정 장치·보톡스 주사를 통한 교합 이완 (턱관절 해부와 별도)
- **심미보철치료**: 라미네이트·치아미백·심미 크라운·올세라믹·심미 인레이 등 외모 개선 목적 보철 (기능 회복 보철과 구분)
- **보존치료**: 충치 제거 후 레진·인레이·온레이로 자연치아 살리는 시술. 발치 없이 치아 보존하는 장면·단계 이미지
...
- **외관**: 건물 외부
- **로고**: 로고·브랜드 그래픽
- **일반**: 그래프·통계표·병원 로고가 아닌 일반 로고 등 **어떤 시술에도 해당 안 되는 경우만** (뉴스 기사는 "기사" 태그 사용)

## 규칙
1. **최대 2개 태그**
2. 시술/질환 태그에 하나라도 해당되면 **반드시 그 태그 사용**. "일반"은 정말로 어떤 시술에도 해당 안 될 때만.
3. 뉴스 기사·신문 캡처 → **"기사" 태그 필수** + 내용에 맞는 시술 태그 병행. 그래프·통계표만 → "일반". (치아/시술 모형은 해당 시술 태그로 분류)
4. "임플란트" 는 실제 임플란트 시술/보철물이 명확히 보일 때만
5. **상담 장면은 "상담" 태그만 단독** — 의사가 환자와 대화/설명하는 장면에 시술 태그 병행 금지.
6. **뉴스 기사/캡처** — B 태그는 반드시 "기사". A 태그는 기사 내용이 다루는 시술/질환.
   예: 사랑니 발치 뉴스 → ["사랑니", "기사"], 임플란트 합병증 뉴스 → ["임플란트", "기사"]
   기사 내용에 맞는 시술 태그 없으면 → ["일반", "기사"]
