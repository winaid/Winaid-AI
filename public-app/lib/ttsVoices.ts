...
// Gemini 30개 목소리 이름 (공용)
const GEMINI_VOICE_NAMES: Array<{ name: string; label: string; gender: 'male' | 'female' | 'neutral'; desc: string; rec?: boolean }> = [
  // 여성
  { name: 'Aoede', label: 'Aoede (밝고 명랑한 여성)', gender: 'female', desc: '밝고 에너지 넘치는 톤' },
  { name: 'Leda', label: 'Leda (차분한 여성)', gender: 'female', desc: '차분하고 신뢰감 있는 톤 — 병원 추천', rec: true },
  { name: 'Kore', label: 'Kore (또렷한 여성)', gender: 'female', desc: '또렷하고 전문적인 톤 — 설명 추천', rec: true },
  { name: 'Callirhoe', label: 'Callirhoe (부드러운 여성)', gender: 'female', desc: '부드럽고 따뜻한 톤' },
  { name: 'Despina', label: 'Despina (활기찬 여성)', gender: 'female', desc: '활기차고 친근한 톤' },
  { name: 'Erinome', label: 'Erinome (감성적 여성)', gender: 'female', desc: '감성적이고 섬세한 톤' },
  { name: 'Laomedeia', label: 'Laomedeia (우아한 여성)', gender: 'female', desc: '우아하고 세련된 톤' },
  { name: 'Autonoe', label: 'Autonoe (자연스러운 여성)', gender: 'female', desc: '자연스럽고 편안한 톤' },
  { name: 'Pulcherrima', label: 'Pulcherrima (고급 여성)', gender: 'female', desc: '고급스럽고 품격 있는 톤' },
  { name: 'Vindemiatrix', label: 'Vindemiatrix (안정적 여성)', gender: 'female', desc: '안정적이고 믿음직한 톤' },
  // 남성
  { name: 'Charon', label: 'Charon (신뢰감 남성)', gender: 'male', desc: '깊고 신뢰감 있는 톤 — 병원 추천', rec: true },
  { name: 'Fenrir', label: 'Fenrir (저음 남성)', gender: 'male', desc: '낮고 묵직한 톤' },
  { name: 'Orus', label: 'Orus (밝은 남성)', gender: 'male', desc: '밝고 친근한 남성 톤' },
  { name: 'Puck', label: 'Puck (활발한 남성)', gender: 'male', desc: '활발하고 에너지 넘치는 톤' },
  { name: 'Iapetus', label: 'Iapetus (차분한 남성)', gender: 'male', desc: '차분하고 지적인 톤 — 설명 추천', rec: true },
  { name: 'Enceladus', label: 'Enceladus (따뜻한 남성)', gender: 'male', desc: '따뜻하고 안정적인 톤' },
  { name: 'Gacrux', label: 'Gacrux (전문적 남성)', gender: 'male', desc: '전문적이고 권위 있는 톤' },
  { name: 'Umbriel', label: 'Umbriel (부드러운 남성)', gender: 'male', desc: '부드럽고 편안한 톤' },
  { name: 'Rasalgethi', label: 'Rasalgethi (중후한 남성)', gender: 'male', desc: '중후하고 깊이 있는 톤' },
  { name: 'Sulafar', label: 'Sulafar (또렷한 남성)', gender: 'male', desc: '또렷하고 명확한 톤' },
  // 중성
  { name: 'Zephyr', label: 'Zephyr (중성적)', gender: 'neutral', desc: '중성적이고 현대적인 톤' },
  { name: 'Achernar', label: 'Achernar (맑은)', gender: 'neutral', desc: '맑고 깨끗한 톤' },
  { name: 'Achird', label: 'Achird (생동감)', gender: 'neutral', desc: '생동감 있는 톤' },
  { name: 'Algenib', label: 'Algenib (절제된)', gender: 'neutral', desc: '절제되고 차분한 톤' },
  { name: 'Algieba', label: 'Algieba (풍부한)', gender: 'neutral', desc: '풍부하고 표현력 있는 톤' },
  { name: 'Alnilam', label: 'Alnilam (균형잡힌)', gender: 'neutral', desc: '균형 잡히고 안정적인 톤' },
  { name: 'Sadachbia', label: 'Sadachbia (경쾌한)', gender: 'neutral', desc: '경쾌하고 밝은 톤' },
  { name: 'Sadaltager', label: 'Sadaltager (진중한)', gender: 'neutral', desc: '진중하고 무게감 있는 톤' },
  { name: 'Schedar', label: 'Schedar (선명한)', gender: 'neutral', desc: '선명하고 명확한 톤' },
  { name: 'Zubenelgenubi', label: 'Zubenelgenubi (독특한)', gender: 'neutral', desc: '독특하고 개성 있는 톤' },
];
