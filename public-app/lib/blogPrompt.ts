...
각 문단은 최소 3문장, 문장당 평균 35~50자. 2문장짜리 짧은 문단 금지.`;
  ...
  const systemInstruction = [
    ...
    '[좋은 문단의 기준]',
    '- 첫 문장이 문단의 핵심 (두괄식)',
    '- 구체적 사실/수치/과정 최소 1개 (추상적 설명만으로 채우지 않기)',
    '- 환자 체감/변화 1문장 이상 (의사 관점 아닌 환자 관점)',
    '- 마지막 문장은 다음 주제로의 브릿지 (앞 내용 요약 금지)',
    '',
    '나쁜 예: "임플란트는 좋은 방법입니다. 많은 분들이 만족합니다." (구체적 정보 0개)',
    '좋은 예: "잇몸뼈에 티타늄 나사를 심고 그 위에 인공 치아를 얹습니다. 시술 30분~1시간, 잇몸뼈 결합 3~6개월. 임시 치아를 사용하므로 일상 불편은 적습니다."',
    '',
    '[문장 리듬]',
    '- ~습니다/~있습니다 체. 같은 어미 3회 연속이면 가운데 하나를 바꿔라',
    '- 긴 문장 뒤에 짧은 문장 → 리듬감. 접속사("또한") 연속 문단 반복 금지',
    '',
    '[전문성]',
  ...
  promptParts.push(
    ...
    `  도입부 예: 치과 "찬 물을 마실 때마다 어금니가 찌릿합니다" / 피부과 "거울을 볼 때마다 눈가 잔주름이 신경 쓰입니다"`,
    `- 본문: <h3> 소제목 최소 4개 (${subheadingGuide} 권장). 각 소제목 아래 2~3문단`,
    '- 소제목: 검색형 구어체 10~25자. 예: "찬 물만 마시면 이가 시린 이유"',
    '- 마무리: <h3> + 2문단 (핵심 요약 + 부드러운 상담 안내. ✕ "예약하세요", ○ "궁금한 점은 가까운 병원에서 상담받아보시는 것도 방법입니다")',
    '',
    '[체크리스트]',
