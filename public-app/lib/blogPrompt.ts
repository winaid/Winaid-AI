...
export function buildBlogPromptV3(
  ...
  const styleOverrideBlock = req.stylePromptText && req.stylePromptText.trim() ? [
...
export function buildBlogReviewPrompt(
  draftHtml: string,
  ctx: { category?: string; hospitalName?: string; ruleFilterViolations?: string[]; stylePromptText?: string } = {},
  ...
  const styleOverride = ctx.stylePromptText && ctx.stylePromptText.trim()
