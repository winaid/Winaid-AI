...
7. "비용", "가격" 관련 키워드는 제외
8. 10개 생성
⚠️ 반드시 위 주소에 해당하는 지역만 사용하세요. 같은 이름의 다른 지역(예: 광주광역시 vs 경기도 광주시)을 혼동하지 마세요. 주소의 시/도를 기준으로 정확한 지역 키워드를 생성하세요.
...
⚠️ 반드시 위 주소에 해당하는 지역만 사용하세요. 같은 이름의 다른 지역(예: 광주광역시 vs 경기도 광주시)을 혼동하지 마세요.
