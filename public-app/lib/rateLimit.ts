 ...
 *
 * A1a 이전 (next-app/lib/rateLimit.ts) — public-app 으로 복제됨.
 * /api/diagnostic/share 발급 라우트에서 분당/시간당 발급 한도용으로 사용.
 *
 ...
 *
 * 게스트 IP rate limit (in-memory Map 기반) 은 별도 모듈 — lib/guestRateLimit.ts.
 */
