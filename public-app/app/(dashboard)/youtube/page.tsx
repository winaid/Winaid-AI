...
⚠️ "영상에서 확인 필요", "영상 시청 후 확인" 같은 문구는 절대 쓰지 마세요. 요약의 의미가 없어집니다.
⚠️ 확실한 정보가 부족하면, 해당 주제의 일반적인 의학 지식으로 보충하되 "일반적으로 ~로 알려져 있습니다" 식으로 자연스럽게 녹이세요.
⚠️ 영상 내용을 완전히 지어내지는 마세요. 제목/설명에서 유추 가능한 범위 내에서 작성.
