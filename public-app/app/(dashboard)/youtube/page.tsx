...
[분석 규칙 — 매우 중요]
⚠️ Google Search로 영상 제목, 설명, 채널 정보, 관련 기사/블로그 등을 최대한 수집하세요.
⚠️ 수집된 정보를 바탕으로 영상의 핵심 내용을 재구성하세요.
⚠️ "영상에서 확인 필요", "영상 시청 후 확인" 같은 문구는 절대 쓰지 마세요.
⚠️ "영상에서 ~라고 말했다", "영상에서 ~를 설명했다" 식으로 영상 내부 대화를 단정하지 마세요. 당신은 영상을 시청하지 않았습니다.
⚠️ 대신 "영상 제목에 따르면 ~를 다루고 있으며", "해당 주제에 대해 일반적으로 ~로 알려져 있습니다" 식으로 작성하세요.
⚠️ 정보가 부족한 포인트는 해당 의학 주제의 일반 지식으로 채우되, 영상이 말한 것처럼 포장하지 마세요.
