...
2. 각 주제(topic)는 25~40자, 블로그 제목으로 바로 쓸 수 있는 형태
3. 다양한 각도 (비용, 과정, 비교, 주의사항, 사후관리, 기간, 대상 등)
4. condition에는 핵심 질환명 또는 시술명만 (예: "임플란트", "치주염", "라미네이트")
   - topic이 "임플란트 수술 후 붓기 관리법"이면 condition은 "임플란트"
   - topic이 "잇몸병 초기 증상 5가지"이면 condition은 "잇몸병"
...
5. condition에는 핵심 질환명 또는 시술명만 (한 단어~두 단어)
   - topic이 "사랑니 발치 후 식사 가이드"이면 condition은 "사랑니 발치"
