...
const FAQS: { q: string; a: string }[] = [
  ...
  {
    q: '몇 점이면 괜찮은 건가요?',
    a: '75점 이상이면 AI 검색에 잘 노출될 가능성이 높습니다. 50~74점은 개선하면 효과가 바로 보이는 구간이고, 50점 미만이면 공식 홈페이지 구조부터 점검이 필요합니다. \'우선 조치\' 탭에서 가장 효과 큰 항목부터 시작해보세요.',
  },
  {
    q: 'AI 검색에 뜨려면 가장 중요한 게 뭔가요?',
    a: '공식 홈페이지에 의료진 소개·진료과목·시술 상세 페이지가 있는 것이 가장 결정적입니다. 네이버 블로그만 있고 홈페이지가 없으면 AI가 \'이 병원이 뭘 하는 곳인지\' 파악하기 어렵습니다. 두 번째로 중요한 건 구조화 데이터(Dentist 스키마)와 Google 비즈니스 프로필 등록입니다.',
  },
];
