...
> **2026-05-06 정정**: 추후 ADR (`docs/decisions/ARC-001_renderer_unification.md`)
> 분석 결과 next-app 측 렌더러는 dead code 였음 (어디서도 import 0건).
> Option D 적용으로 PR #111 에서 삭제 완료. 본 항목 framing ("두 앱이 동일
> 카드뉴스를 다른 엔진으로 렌더 중") 는 부분 부정확 — 실제는 1 활성 + 1 dead.
