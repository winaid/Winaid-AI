...
export const PERSONA_GUIDES: Record<string, string> = {
  ...
  coordinator: '상담실장 1인칭. 친근·일상어. 의학적 단정 금지 — 진단·시술 결정은 "원장님께서…" 인용 형식. 후기·사례 톤. 의사 권한 영역 침범 X.',
};
...
- 어조: 따뜻·친근·일상어. 환자 시점 공감 phrase 우세.
  "~ 하셨을 거예요", "걱정 많으셨죠?", "비슷한 분들 많이 오세요" 같은 친근체.
- 전문용어는 풀어서 설명: "신경치료(=근관치료라고 하는데요)" 식 부연 / 쉬운 말 변환.
